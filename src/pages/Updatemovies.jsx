            ...
            .then((data) => {
                ...
                if (data.matchedCount) {
                    ...
                    Swal.fire({
                        title: "Update Failed",
                        icon: "error",
                        text: data.message || "There was an issue updating the movie. Please try again later.",
                    });
                }
            })
            .catch((error) => {
    ...
    return (
        <div className="min-h-[calc(100vh-264px)] mt-5">
            <div className="card bg-base-100 w-full max-w-4xl mx-auto shrink-0 shadow-2xl">
                <div>
                    <h2 className="text-center text-3xl pt-4">Update Movie</h2>
                </div>
